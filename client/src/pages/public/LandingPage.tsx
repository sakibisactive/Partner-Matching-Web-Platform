...
import { Heart, Sparkles, ShieldCheck, Zap, MessageSquare, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-24 py-6">
      ...
      <section className="relative overflow-hidden pt-12 pb-16">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-gradient-to-tr from-rose-600/30 via-indigo-500/20 to-amber-500/10 blur-3xl rounded-full -z-10 animate-pulse pointer-events-none" />
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          >
            <Sparkles className="w-4 h-4 text-rose-400" /> AI 5D Compatibility & World Hobbies Matching
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl font-black text-white tracking-tight leading-tight font-outfit uppercase"
          >
            FIND TRU LUV WITH{' '}
            <span className="bg-gradient-to-r from-rose-400 via-indigo-400 to-amber-400 bg-clip-text text-transparent">
          ...
          >
            FIND TRU LUV calculates real compatibility across 50 personality dimensions, comprehensive world hobbies, lifestyle preferences, age range goals, and Haversine geo-distance.
          </motion.p>
          ...
          >
            <Link
              to="/register"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-rose-600 via-indigo-600 to-amber-500 hover:opacity-95 shadow-xl shadow-rose-500/20 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
            >
